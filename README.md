...
I am currently serving as a Sr. Associate Enterprise Architect at Northern Trust, appointed in October 2023. With a robust background in cloud technologies and over four years of IT experience, my expertise spans Kubernetes, Terraform, and CI/CD processes utilizing GitHub Actions. My career began in 2018 as a Cloud Engineer, where I was responsible for designing, provisioning, and maintaining cloud-based systems. Subsequently, I advanced to a DevOps role, significantly contributing to the implementation and maintenance of new clusters, as well as optimizing application performance.

In my current role at Northern Trust, I oversee a detailed process as outlined in our container images cookbook, which includes the selection, building, and publishing of container images. This process begins with conducting performance tests and benchmarking to evaluate the suitability of images for further development. The images that meet our stringent criteria are then hardened, ensuring they are not only secure and robust but also efficient. This methodical approach enhances future maintenance capabilities, reduces operational costs, and ensures the deployment of secure base images for application architects and teams.

I am skilled in leveraging Terraform for infrastructure automation and hold eight professional certifications, including Certified Kubernetes Administrator (CKA), Certified Kubernetes Application Developer (CKAD), AWS Solution Architect, Cloud Practitioner, SysOps Administrator, HashiCorp Terraform Associate, HashiCorp Vault Associate, and Azure Fundamentals. I am passionate about learning new staff and technologies that can be implemented in my daily duties and tasks, continuously enhancing operational efficiencies and my professional development.