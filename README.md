...
In my current role at Northern Trust, I oversee a detailed process as outlined in our container images cookbook, which includes the selection, building, and publishing of container images. This process begins with conducting performance tests to evaluate the suitability of images for further development. The images that meet our stringent criteria are then hardened, ensuring they are not only secure and robust but also efficient. This methodical approach enhances future maintenance capabilities, reduces operational costs, and ensures the deployment of secure base images for application architects and teams.
