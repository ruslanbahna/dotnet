...
RUN jq '.libraries["System.Drawing.Common/4.7.0"] = {"type": "package", "serviceable": false, "sha512": "", "path": "", "hashPath": ""}' Microsoft.Build.Tasks.CodeAnalysis.deps.json > Microsoft.Build.Tasks.CodeAnalysis.modified.deps.json
